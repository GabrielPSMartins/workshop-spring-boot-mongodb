...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("23/01/2025"), "Partiu estudar", "Vamos começar mais um dia de estudo. Boa sorte pra nós!", maria);
		Post post2 = new Post(null, sdf.parse("25/01/2025"), "Vamos ler um pouco!", "Hoje estou com vontade de ler para relaxar.", maria);
